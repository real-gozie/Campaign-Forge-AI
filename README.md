...
<img src="assets/banner.png" alt="Campaign Forge AI Banner" width="100%"/>
...
Campaign Forge AI was developed with the support of multiple AI tools, each serving a distinct role in the development and product experience.

## 💬 ChatGPT — Brainstorming & Ideation

ChatGPT was used primarily as a brainstorming and ideation partner during the development process.

It supported activities including:

- Exploring and refining the initial product concept.
- Brainstorming product features and user experiences.
- Challenging assumptions and exploring alternative approaches.
- Refining product language, messaging, and documentation.
- Thinking through technical and architectural options.

ChatGPT was used as a collaborative thinking tool rather than as the primary development environment.

## 🛠️ IBM Bob — Development, Implementation & Debugging

IBM Bob was the primary development environment used to prototype and build Campaign Forge AI.
...
- Integrating IBM Granite and IBM watsonx.ai.
- Implementing the Cloudflare Worker proxy architecture.
- Debugging and troubleshooting implementation issues.
- Identifying and resolving errors.
- Iterating on features and functionality.
- Refining the application through sprint-based development and testing.
- Validating and improving the working prototype.

IBM Bob played a central role in transforming the Campaign Forge AI concept into a functional prototype.

## 🤖 IBM Granite — AI Inside the Product

IBM Granite is the foundation model used within Campaign Forge AI itself.

Unlike the development tools described above, Granite is part of the product's AI-assisted campaign-development workflow.
...
- Five-perspective expert review.
- Strategic insights and recommendations.
- Identification of campaign strengths, weaknesses, risks, and opportunities.
- Support for campaign refinement and development.

Granite is accessed through IBM watsonx.ai, with a Cloudflare Worker providing the server-side proxy layer.

## 🧠 Human Direction

AI tools supported the development process, but the product concept, campaign methodology, FORGE Framework, design direction, and final decisions remained human-directed.

This reflects the same philosophy behind Campaign Forge AI:

> **AI should strengthen human thinking and creativity—not replace them.**

The different AI tools therefore served complementary roles:

**Human Vision & Direction**  
↓  
**ChatGPT — Brainstorming & Ideation**  
↓  
**IBM Bob — Development, Implementation & Debugging**  
↓  
**IBM Granite — AI-Assisted Campaign Intelligence**  
↓  
**Campaign Forge AI — From Idea to Action**

# 📄 License

Campaign Forge AI is licensed under the [MIT License](LICENSE).

The project is shared as an open-source prototype to encourage experimentation, learning, and further development.
